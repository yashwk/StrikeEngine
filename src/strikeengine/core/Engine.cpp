...
namespace StrikeEngine {
    ...
    void Engine::initializeSystems()
    {
        ...
        auto navigation_system = std::make_unique<NavigationSystem>();
        ...
        auto aerodynamics_system = std::make_unique<AerodynamicsSystem>(_atmosphere_manager);
       ...
       // auto endgame_system = std::make_unique<EndgameSystem>();
        ...
        System* p_navigation = _system_graph.addSystem(std::move(navigation_system));
        ...
        System* p_aerodynamics = _system_graph.addSystem(std::move(aerodynamics_system));
