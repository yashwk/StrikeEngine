...
namespace StrikeEngine::Kernel {
    ...
    struct SeekerBlock {
        ...
        void ensureSize(std::size_t n) {
            ...
            growTo(noiseFloorW, n, 1e-12);
            growTo(snrThresholdDb, n, 13.0);
            growTo(sensitivityW, n, 1e-9);
            growTo(wavelengthBand, n, 0);
            growTo(irExtinctionPerM, n, 1e-4);
            growTo(illuminatorPx, n, 0.0);
            growTo(illuminatorPy, n, 0.0);
            growTo(illuminatorPz, n, 0.0);
            growTo(illuminatorPowerW, n, 5.0e5);
            growTo(illuminatorGainDb, n, 38.0);
            growTo(illuminatorWavelengthM, n, 0.03);
            growTo(fieldOfViewHalfAngleRad, n, 1.0471975512);
            growTo(gimbalAzimuthLimitRad, n, 1.0471975512);
            growTo(gimbalElevationLimitRad, n, 1.0471975512);
            growTo(lockHysteresisDb, n, 3.0);
            growTo(lockDropoutTimeSec, n, 0.10);
            growTo(measurementLatencySec, n, 0.0);
            growTo(measurementNoiseEnabled, n, false);
            growTo(angleNoiseStdDevRad, n, 0.001);
            growTo(angleNoiseRefSnrDb, n, 20.0);
            growTo(rangeNoiseStdDevM, n, 1.0);
            growTo(rangeRateNoiseStdDevMps, n, 0.5);
            growTo(glintSigmaM, n, 0.0);
            growTo(glintCorrelationTauSec, n, 1.0);
            growTo(swerlingEnabled, n, false);
            growTo(gimbalRateLimitRadPerSec, n, 0.0);
            growTo(minRangeGateM, n, 0.0);
            growTo(maxRangeGateM, n, 0.0);
            growTo(terrainMaskingEnabled, n, false);
            growTo(minClosingRateMps, n, 0.0);
            growTo(rateFilterTauSec, n, 0.05);
            ...
            growTo(targetRangeRate, n, 0.0);
            growTo(targetAzimuth, n, 0.0);
            growTo(targetElevation, n, 0.0);
            growTo(targetAzimuthRate, n, 0.0);
            growTo(targetElevationRate, n, 0.0);
            growTo(losRateFilterAz, n, 0.0);
            growTo(losRateFilterEl, n, 0.0);
            growTo(losRateWorldX, n, 0.0);
            growTo(losRateWorldY, n, 0.0);
            growTo(losRateWorldZ, n, 0.0);
            growTo(losRateWorldValid, n, false);
            growTo(losRateWorldStateX, n, 0.0);
            growTo(losRateWorldStateY, n, 0.0);
            growTo(losRateWorldStateZ, n, 0.0);
            growTo(prevLosWorldX, n, 0.0);
            growTo(prevLosWorldY, n, 0.0);
            growTo(prevLosWorldZ, n, 0.0);
            growTo(prevLosWorldTimeSec, n, 0.0);
            growTo(bodyRateFilteredX, n, 0.0);
            growTo(bodyRateFilteredY, n, 0.0);
            growTo(bodyRateFilteredZ, n, 0.0);
            growTo(bodyRateStateX, n, 0.0);
            growTo(bodyRateStateY, n, 0.0);
            growTo(bodyRateStateZ, n, 0.0);
            growTo(prevBodyRateX, n, 0.0);
            growTo(prevBodyRateY, n, 0.0);
            growTo(prevBodyRateZ, n, 0.0);
            growTo(gyroIntX, n, 0.0);
            growTo(gyroIntY, n, 0.0);
            growTo(gyroIntZ, n, 0.0);
            growTo(prevStepGyroX, n, 0.0);
            growTo(prevStepGyroY, n, 0.0);
            growTo(prevStepGyroZ, n, 0.0);
            growTo(previousAzimuth, n, 0.0);
            growTo(previousElevation, n, 0.0);
            growTo(timeSinceCommitSec, n, 0.0);
            growTo(seekerClockSec, n, 0.0);
            growTo(lockLostTimeSec, n, 0.0);
            growTo(hasPreviousLos, n, false);
            growTo(lockActive, n, false);
            growTo(hasPublishedMeasurement, n, false);
            growTo(measurementAgeSec, n, 0.0);
            growTo(gimbalAzimuthRad, n, 0.0);
            growTo(gimbalElevationRad, n, 0.0);
            growTo(lastSignalStrength, n, 0.0);
            growTo(lockRejectReason, n, static_cast<int>(SeekerRejectReason::None));
            growTo(glintAzM, n, 0.0);
            growTo(glintElM, n, 0.0);
            if (n > size) size = n;
        }
    };
