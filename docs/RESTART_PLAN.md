...
The interrupted engine-fidelity repair was resumed and completed through W14.
The CPU build succeeds and the full CTest suite passes **19/19**. The repair
...
W12 spherical point-mass gravity MVP, the W13 standalone rotating-Earth ECEF
propagator, and the W14 opt-in kernel ECEF truth mode are also covered. The
historical
